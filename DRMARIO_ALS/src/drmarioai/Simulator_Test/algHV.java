...
public class algHV{
    ...
    public static void print_bottle(){
        for(int r=(rows-1); r>=0; r--){
            for(int c=0; c<cols; c++){
                ...
                if(value == EMPTY_TILE){
                    System.out.print("-"); 
                }else if((value&COLOR_MASK)==YELLOW){
                    System.out.print("Y");
                }else if((value&COLOR_MASK)==RED){
                    System.out.print("R");
                }else if((value&COLOR_MASK)==BLUE){
                    System.out.print("B");
                }
            }
            System.out.println("");
    ...
    public static int[] available(int row, int col){
        ...
        if(row-2>=0){
            if(bottle[row-2][col]!=EMPTY_TILE){
                available[(bottle[row-2][col]&0xF)] = -1; 
            }
        }
        if(col-2>=0){
            if(bottle[row][col-2]!=EMPTY_TILE){
